...
const props = withDefaults(
  defineProps<ProgressRootProps & { class?: HTMLAttributes["class"]; color?: Color }>(),
...
<template>
  <ProgressRoot
    ...
    <ProgressIndicator
      :class="
        cn('flex-1 w-full h-full transition-all duration-500 bg-primary', colors[props.color].bar)
      "
